...
img_dither_pil_blue = dithizacao_direta(r"comp-aplicadaV/Ditherizacao/canais/imagem_blue.png")
img_dither_pil_green = dithizacao_direta(r"comp-aplicadaV/Ditherizacao/canais/imagem_green.png")
img_dither_pil_red = dithizacao_direta(r"comp-aplicadaV/Ditherizacao/canais/imagem_red.png")
...
cv.imwrite('imagem_ditherizada_colorida_pil.png', imagem_ditherizada_colorida)
