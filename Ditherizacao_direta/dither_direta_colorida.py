...
img_dither_pil_blue = dithizacao_direta(r"canais/imagem_blue.png")
img_dither_pil_green = dithizacao_direta(r"canais/imagem_green.png")
img_dither_pil_red = dithizacao_direta(r"canais/imagem_red.png")
